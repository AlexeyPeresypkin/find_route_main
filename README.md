...
Приложение позволяет производить поиск маршрута перемещения из одной точки в другую. Проект разделён на 3 приложения:  населенные пункты, поезда, маршруты.

## Населенные пункты.
Реализовано добавление, редактирование, удаление населенного пункта, а также постраничный просмотр всех доступных населенных пунктов.
## Поезда.
Реализовано добавление, редактирование, удаление поезда, а также постраничный просмотр всех доступных поездов. У поезда есть уникальный код (название), начало маршрута, конец маршрута и время в пути в условных единицах. Из одной точки в другую может быть несколько поездов, но они должны отличаться по времени в пути.
## Маршруты.
